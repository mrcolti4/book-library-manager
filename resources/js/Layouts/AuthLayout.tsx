...
export default function AuthLayout({ children }: props) {
    return (
        <div className="bg-dark-950 flex gap-4 p-7 sm:h-screen max-sm:grid">
            <SectionWrapper className="lg:w-1/2 bg-dark-900 rounded-xl px-8 py-6 md:px-16 md:py-10 flex flex-col">
                <ApplicationLogo />
            ...
            <SectionWrapper className="lg:w-1/2 items-center justify-center lg:items-end max-sm:flex hidden lg:flex">
                <img
